const Home = () => {
  ...
  return (
            ...
            <ul>
              <li><a href="#">
                <svg viewBox="0 0 192 192">
                  <path className="icon" fill="#627d8b" d="m155.109 74.028a4 4 0 0 0 -3.48-2.028h-52.4l8.785-67.123a4.023 4.023 0 0 0 -7.373-2.614l-63.724
    ...
    .048-4.027z"/>
              ...
              <li><a href="#">
                <svg viewBox="0 0 58 58">
                  <path className="icon" fill="#627d8b" d="M57,6H1C0.448,6,0,6.447,0,7v44c0,0.553,0.448,1,1,1h56c0.552,0,1-0.447,1-1V7C58,6.447,57.552,6,57,6z M10,50H2v-9h8V50z
    ...
    L 1.6604 3.7146 L 0.0778 5.2972 A 0.2646 0.2646 0 0 0 0.0599 5.3151 Z"/>
                  <path className="icon" fill="#627d8b" d="M 2.0346 3.3405 L 5.1267 6.4325 L 8.3886
    ...
    5.55-5.19V10.24A5.15,5.15,0,0,0,76.31,5Z"/>
                  <path className="icon" fill="#627d8b" d="M65.2,16.13H23.69a5.15,5.15,0,0,0-5.1,5.21V89.77a5.1,5.1,0,0,0,8,4.28L41.93,83.22a5,5,0,0,1,5.88,
    0L62.23,93.81a5.11,5.11,0,0,0,8.08-4.24V21.34A5.16,5.16,0,0,0,65.2,16.13Z"/>
        ...
        -13.59374 a 2.0002,2.0002 0 0 1 1.1875,-3.4375 z" fill="#E6EBEF" fillOpacity="1" fillRule="evenodd" stroke="none" marker="none" visibility="visible" display="inline" overflow="visible"/>
              </g>
            </svg>
          </button>
          <div className="big-movie-info">
            ...
            <div className="info-last"></div>
          </div>

          <article id="bottom-screen">
            <article id="mid-nav">
              <a className="one" href="#">SHOWTIMES</a>
              <a className="two" href="#">DETAILS</a>
              <div id="nav-layer"></div>
              <svg>
                <rect id="text-bg" width="50%" height="100%" fill="#4c17ff" x="50%" y="0" rx="7" fillOpacity="1" mask="url(#knockout-text)"/>
                <mask id="knockout-text">
                  <rect width="100%" height="100%" fill="#fff" x="0" y="0"/>
                  <text x="25%" y="57.5%" fill="#000" fontSize="11px" fontWeight="700" textAnchor="middle">SHOWTIMES</text>
                  <text x="75%" y="57.5%" fill="#000" fontSize="11px" fontWeight="700" textAnchor="middle">DETAILS</text>
                </mask>
              </svg>
            </article>
